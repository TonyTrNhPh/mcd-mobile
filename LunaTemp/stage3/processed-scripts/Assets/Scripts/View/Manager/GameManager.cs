...
namespace View.Manager
{
    public class GameManager : MonoBehaviour
    {
        ...
        public void ChangeState(EGameState state)
        {
            ...
            switch (state)
            {
                case EGameState.Landing:
                    newState = _landingState;
                    break;
        ...
        {
            HandleLevelStart(levelData, true);
        }

        public void HandleLevelStart(LevelData levelData, bool startLevel)
        {
            if (!LevelManager.LoadLevel(levelData, startLevel))
                return;
