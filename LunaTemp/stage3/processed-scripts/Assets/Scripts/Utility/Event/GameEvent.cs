...
public static class GameEvent
{
    ...
    public static event Action OnCatAdded = delegate { };
    public static event Action<Slot> OnCatRegistered = delegate { };
    ...
    public static void HandleCatAdded() => OnCatAdded?.Invoke();
    public static void HandleCatRegistered(Slot slot) => OnCatRegistered?.Invoke(slot);
}